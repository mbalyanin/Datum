    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seeking', models.CharField(choices=[('M', 'Мужчин'), ('F', 'Женщин'), ('A', 'Всех')], default='A', max_length=1, verbose_name='Ищу')),
                ...
                ('bio', models.TextField(blank=True, max_length=2000, verbose_name='О себе')),
                ('hobbies', models.CharField(blank=True, max_length=255, verbose_name='Хобби')),
